...
getConfigFile.done(function() {
	...
	formOptions.dxfTime = {
		"type": "generic",
		"noParse": true,
		"template": "<label for='dxf-file-picker'><span data-form-el-type='file' class='form-control btn-default form-simple-button form-file-picker job-file-upload' data-toggle='tooltip' data-placement='bottom' title='Drag your DXF here, or click the button'>Upload DXF<input type='file' id='dxf-file-picker'></span></label>",
		"onRender": function() {
